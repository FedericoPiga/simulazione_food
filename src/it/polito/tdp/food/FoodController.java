...
public class FoodController {
    ...
    void doCalcolaDieta(ActionEvent event) {
    	...
    	Condiment scelto = boxIngrediente.getValue();
    	
    	txtResult.setText("Dieta equilibrata:\n");
    	
    	for(Condiment c : model.getDietaEquilibrata(scelto)) {
    ...
    void doCreaGrafo(ActionEvent event) {
    	...
    	txtResult.setText(model.getIngredienti());
    	
    	boxIngrediente.getItems().addAll(model.getListaIngredienti());
